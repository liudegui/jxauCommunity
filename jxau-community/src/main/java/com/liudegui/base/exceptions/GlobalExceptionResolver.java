package com.liudegui.base.exceptions;
...
public class GlobalExceptionResolver implements HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object handler, Exception ex) {
        ...
        if(handler instanceof  HandlerMethod){
            if(ex instanceof  ParamsException){
                 ...
                 * 处理用户未登录
                 */
                if(exception.getCode().equals(Constant.OPS_FAILED_DODE) ){
                    modelAndView.addObject("msg","用户未登录");
                    modelAndView.addObject("code", Constant.LOGIN_FAILED_DODE);
                    return modelAndView;
                }
    ...
    private ModelAndView createDefaultModelAndView(HttpServletRequest httpServletRequest){
        ...
        modelAndView.addObject("code",Constant.OPS_FAILED_DODE);
        modelAndView.addObject("msg", Constant.OPS_FAILED_MSG);
